...
struct Z_CompiledInDeferFile_FID_Unreal_Projects_SecondWind_Source_SecondWind_Actors_TrainingDummy_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATrainingDummy, ATrainingDummy::StaticClass, TEXT("ATrainingDummy"), &Z_Registration_Info_UClass_ATrainingDummy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATrainingDummy), 154819491U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_SecondWind_Source_SecondWind_Actors_TrainingDummy_h_687252448(TEXT("/Script/SecondWind"),
