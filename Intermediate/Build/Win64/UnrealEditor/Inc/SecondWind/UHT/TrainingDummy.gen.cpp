...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ATrainingDummy_Statics::NewProp_PhysicsHitReactionComponent = { "PhysicsHitReactionComponent", nullptr, (EPropertyFlags)0x00200800000a001d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATrainingDummy, PhysicsHitReactionComponent), Z_Construct_UClass_UPhysicsHitReactionComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PhysicsHitReactionComponent_MetaData), NewProp_PhysicsHitReactionComponent_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ATrainingDummy_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATrainingDummy_Statics::NewProp_PhysicsHitReactionComponent,
...
struct Z_CompiledInDeferFile_FID_Unreal_Projects_SecondWind_Source_SecondWind_Actors_TrainingDummy_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATrainingDummy, ATrainingDummy::StaticClass, TEXT("ATrainingDummy"), &Z_Registration_Info_UClass_ATrainingDummy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATrainingDummy), 94421442U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_SecondWind_Source_SecondWind_Actors_TrainingDummy_h_3300552652(TEXT("/Script/SecondWind"),
